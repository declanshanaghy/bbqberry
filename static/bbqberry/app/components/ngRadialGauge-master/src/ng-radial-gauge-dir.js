        ...
        return {
            ...
            link: function (scope, ele, attrs) {
                ...
                var getNewAngle = function (pValue) {
                    ...
                    var scaleRange = 2 * gaugeAngle;
                    var minScale = -1 * gaugeAngle;
                    return minScale + (ratio * scaleRange);
                };
                ...
                scope.render = function () {
                    ...
                    renderTimeout = $timeout(function () {
                        ...
                        if (typeof ranges === 'undefined') {
                            d3DataSource.push([minLimit, maxLimit, inactiveColor, inactiveColor]);
                        } else {
                            //Data Generation
                            ranges.forEach(function (pValue, index) {
                                d3DataSource.push([pValue.min, pValue.max, pValue.color, pValue.stroke]);
                            });
                        }
