...
// RecorderResponseWriter provides an interface for recording what happened in an HTTP request
type RecorderResponseWriter interface {
	http.ResponseWriter
	http.Flusher
	...
	Before(func(RecorderResponseWriter))
}

type beforeFunc func(RecorderResponseWriter)
...
// NewRecorderResponseWriter creates an object which is capable of recording what happened in an HTTP request
func NewRecorderResponseWriter(w http.ResponseWriter, statusCode int) RecorderResponseWriter {
...
func (r *recorderResponseWriter) Before(before func(RecorderResponseWriter)) {
