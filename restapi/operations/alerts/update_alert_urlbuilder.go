...
func (o *UpdateAlertURL) Build() (*url.URL, error) {
	...
	probe := swag.FormatInt64(o.Probe)
	if probe != "" {
		qs.Set("probe", probe)
	}
...
func (o *UpdateAlertURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateAlertURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateAlertURL")
	}
