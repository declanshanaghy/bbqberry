...
// UpdateAlertParams contains all the bound params for the update alert operation
...
func (o *UpdateAlertParams) bindProbe(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
	...
	if err != nil {
		return errors.InvalidType("probe", "query", "int64", raw)
	}
	o.Probe = value
...
func (o *UpdateAlertParams) validateProbe(formats strfmt.Registry) error {
