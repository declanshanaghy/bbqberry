...
//
// swagger:parameters getProbeReadings
...
func (o *GetProbeReadingsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetProbeReadingsParams) bindProbe(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetProbeReadingsParams) validateProbe(formats strfmt.Registry) error {
