...
func (o *ShutdownReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewShutdownDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *ShutdownDefault) Error() string {
	return fmt.Sprintf("[PUT /system/shutdown][%d] shutdown default  %+v", o._statusCode, o.Payload)
}

func (o *ShutdownDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
