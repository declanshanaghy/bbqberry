...
func (o *GetHardwareReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewGetHardwareDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetHardwareOK) Error() string {
	return fmt.Sprintf("[GET /hardware][%d] getHardwareOK  %+v", 200, o.Payload)
}

func (o *GetHardwareOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetHardwareDefault) Error() string {
	return fmt.Sprintf("[GET /hardware][%d] getHardware default  %+v", o._statusCode, o.Payload)
}

func (o *GetHardwareDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
